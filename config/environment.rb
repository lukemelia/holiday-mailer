...
Rails::Initializer.run do |config|
  ...
  %w[mailers].each do |dir|
    config.load_paths += Dir[File.join(RAILS_ROOT, 'app', dir)]
    config.load_paths += Dir[File.join(RAILS_ROOT, 'app', dir, '**')]
  end
  
  config.action_mailer.template_root = "#{RAILS_ROOT}/app/mail_templates"
  ...
  config.action_controller.session = {
    :session_key => '_holiday_mailer_session',
    :secret      => 'a3e2a51a371bb964a4250h2las93483fb224d455171dcba55518e74af43366e52e3f239773f90aed0ab6caf6554f051504ce7232599d066150dbabff0f1654'
  }
