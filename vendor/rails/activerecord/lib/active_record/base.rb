  ...
  class Base
    ...
    class << self # Class methods
      ...
      def protected_attributes # :nodoc:
        read_inheritable_attribute(:override_attr_protected) || read_inheritable_attribute(:attr_protected)
      end
      
      def without_attribute_protection
        write_inheritable_attribute(:override_attr_protected, []) 
        result = yield
        write_inheritable_attribute(:override_attr_protected, nil) 
        return result
      end
